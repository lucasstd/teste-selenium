...
class LowValuesTest(BaseCase):
    ...
    def test_low_values(self):
        ...
        self.update_text(PageObjects.input_valor_aplicar, '999999999999999999999999,00')
        # Preenche valor que você quer poupar com 20,00
        self.update_text(PageObjects.input_valor_investir, '999999999999999999999999,00')
        # Por quanto tempo você quer poupar com 20
        self.update_text(PageObjects.input_quanto_tempo, '9')
